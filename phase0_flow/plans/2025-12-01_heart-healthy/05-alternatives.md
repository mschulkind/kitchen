...
*   **Flavor Base:** 1-2 Sausages (sliced), 3 cloves Garlic (minced), 1-2 tbsp Tomato Paste.
*   **Liquids:** 1 can (28oz) Tomatoes (hand-crushed), 4 cups Pork Broth.
*   **Beans:** 2 cans Cannellini (rinsed).
*   **Finish:** 1 cup Ditalini, Herbs (Rosemary/Bay Leaf).

**Execution:**
1.  **Render:** Brown sausage slices in oil -> remove or keep in.
2.  **Sweat:** Add onion/carrot/celery to fat -> soft (8m).
3.  **Deepen:** Add garlic & paste -> fry paste till rust color (2m).
4.  **Simmer:** Add tomatoes & broth & herbs -> simmer 20m.
5.  **Pasta:** Add beans & ditalini -> simmer till al dente (10m).
...
*   **Sweat** mirepoix in rendered fat + oil. S&P.
*   **Pincé** (fry) tomato paste w/ garlic till rust-colored.
*   **Deglaze** w/ hand-crushed tomatoes. Scrape fond.
*   **Build** w/ broth, aromatics (bay/rosemary/rind). Simmer 20m.
*   **Drop** pasta & beans. Cook to al dente.
*   **Finish** w/ balsamic splash & fresh herbs.
...
| Time | Action | Notes |
| :--- | :--- | :--- |
| **T-45** | Prep Veggies | Dice onion, carrot, celery. Slice sausage. |
| **T-40** | **HEAT ON** | Brown sausage. |
| **T-35** | Sauté | Add veggies to sausage fat. **Prep Garlic.** |
| **T-25** | Fry Paste | Add garlic & paste. **Open Cans.** |
| **T-22** | Build Soup | Add tomatoes, broth, herbs. Bring to boil. |
| **T-20** | **Simmer** | Low heat. **Clean up prep board.** |
| **T-10** | Add Pasta | Drop ditalini & beans. Stir often. |
| **T-0** | **SERVE** | Remove rind/bay leaf. Season & Serve. |