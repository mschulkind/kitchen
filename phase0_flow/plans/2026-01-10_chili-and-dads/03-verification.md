...
- [ ] **Carrots** (2 lbs) for Stew, Curry, and snacking.
- [ ] **Celery** (1 bunch) for Stew & Chowder.
- [ ] **Brussels Sprouts** (1 lb) for side with Chowder.
...
- [x] **Russet Potatoes** (Use from massive stock).
