...
**Selected Plan:** The "Mix & Match" Custom 🛠️

-   **Monday:** Turkish Lentil Soup w/ Shirazi Salad (Lime).
-   **Tuesday:** Mediterranean Bowl (Chickpeas/Roots).
-   **Thursday:** Beef & Broccoli Stir-Fry (Velveted).
...
-   [ ] **Limes** (3-4) for Shirazi Salad (user requested Lime).
-   [ ] **Fresh Mint** (1 bunch) for Shirazi & Bowl (Crucial for flavor layer).
-   [ ] **Fresh Dill** (1 bunch) for Med Bowl yogurt sauce.
-   [ ] **Broccoli** (2 large heads) for Stir-Fry (Need double volume).
-   [ ] **Scallions** (1 bunch) for Stir-Fry garnish.
...
-   **Monday:** Soup + Shirazi (Lime).
-   **Tuesday:** Med Bowl (Chickpeas + Roasted Roots).
-   **Thursday:** Beef & Broccoli (Velveted for tenderness).
